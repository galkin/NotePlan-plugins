...
export { randomNextToDo, randomProject } from './NPPluginMain' // add one of these for every command specified in plugin.json (the function could be in any file as long as it's exported)
